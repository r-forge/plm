...
pFtest.plm <- function(x, z, ...){
  ...
  ssrp <- sum(pooling$residuals^2)
  ssrw <- sum(within$residuals^2)
...
#
#  Maybe rename this function to pwaldtest as we already have pFtest and the
#  current pwaldtest seems obsolete.
#
