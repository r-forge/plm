...
##   ->  element na.action in the plm object added in rev. ######## TODO
##       This element is needed for residuals() to do NA padding
##
##  this test file did not run properly before rev. ######## TODO
...
summary(plm_gr_na_pass)          # TODO: TSS: NA, R-sq, adj.-Rsq, Fstat, p-val
